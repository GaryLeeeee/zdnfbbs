						...
						var l = {
							...
							d = function(t, o) {
								...
								if (n !== !1) {
									var r = void 0,
										s = void 0;
									t.top ? (l.top = 0, r = o.top) : (l.bottom = 0, r = -o.bottom), t.left ? (l.left = 0, s = o.left) : (l.right = 0, s = -o.right), l[k] = "translateX(" + "20" + "px) translateY(" + Math.round(r) + "px)", "msTransform" !== k && (l[k] += " translateZ(0)")
